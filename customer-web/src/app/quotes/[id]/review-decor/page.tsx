...
export default function QuoteReviewDecorPage() {
    ...
    <>
      ...
      <main className={styles.page}>
        <div className={styles.breadcrumb}>
          ...
          <span className={styles.sep}>/</span>
          <span className={styles.current}>Review Decor Quote</span>
        </div>
        ...
        <div className={styles.dashLayout}>
          ...
          <div className={styles.dashContent}>
            ...
            <div className={styles.pageHead}>
              <h1 className={styles.pageTitle}>Review Decor Quote</h1>
              <p className={styles.pageSub}>Review the proposed decor elements and setup pricing.</p>
            </div>
                ...
                <div className={styles.qdItems}>
                  <div className={styles.qdItem}>
                    ...
                    <div className={styles.qdItemMain}>
                      <div className={styles.qdItemName}>Entrance Arch Floral</div>
                      <div className={styles.qdItemTag}>Entrance</div>
                    </div>
                  </div>
                  <div className={styles.qdItem}>
                    <div className={styles.qdItemImg} style={{ background: '#eee' }}></div>
                    <div className={styles.qdItemMain}>
                      <div className={styles.qdItemName}>Stage Backdrop</div>
                      <div className={styles.qdItemTag}>Stage</div>
                    </div>
                  </div>
                </div>
              </div>
