    ...
    <DashboardLayout breadcrumbTitle="Profile">
      ...
      <div className={styles.tileGrid}>
        ...
        <Link href="/quotes" className={styles.gridTile}>
          <div className={styles.gridTileIcon}><i className="bx bx-receipt"></i></div>
      ...
      <div className={styles.tileGrid}>
        ...
        <Link href="/profile/payment" className={styles.gridTile}>
        ...
        <Link href="/profile/edit" className={styles.gridTile}>
